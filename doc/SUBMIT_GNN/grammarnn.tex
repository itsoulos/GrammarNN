...
%
\end{enumerate}
The steps of the overall algorithm are outlined graphically in Figure
\ref{fig:flow}.
...
.
\end{enumerate}
The number of classes for each used dataset are shown in Table \ref{tab:The-classification-datasets}.
\begin{table}[H]
...
\end{enumerate}
The number of features for each regression dataset incorporated in
the current work are shown in Table\textcolor{brown}{{} \ref{tab:The-regression-datasets}.}
\begin{table}[H]
...
\ref{fig:statClass}) to compare the models from Table \ref{tab:expClass}
